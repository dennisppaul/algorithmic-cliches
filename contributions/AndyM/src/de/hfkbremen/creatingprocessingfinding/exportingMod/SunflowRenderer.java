package de.hfkbremen.creatingprocessingfinding.exportingMod;


import de.hfkbremen.creatingprocessingfinding.exporting.*;
...
public class SunflowRenderer
    ...
    public static SunflowRenderer render(PApplet pApplet, String pDrawMethodName, Class invokingClass) {
        return new SunflowRenderer(pApplet, pDrawMethodName, invokingClass);
    }

    final Class mClass;
            
    public SunflowRenderer(PApplet pParent, String pMethodName, Class invokingClass) {
        mParent = pParent;
        mClass = invokingClass;
