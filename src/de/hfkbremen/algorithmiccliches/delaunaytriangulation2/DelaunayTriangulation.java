...
public class DelaunayTriangulation {
    ...
    public static ArrayList<DelaunayTriangle> triangulate(ArrayList<PVector> theVertices) {
        sort(theVertices);
        return triangulateSortedVertices(theVertices);
    }

    public static ArrayList<DelaunayTriangle> triangulateSortedVertices(ArrayList<PVector> theVertices) {
        /*
...
//                yc = _myCircle.y;
    ...
    public static boolean addVertexSafely(ArrayList<PVector> pVertices,
                                          PVector pNewVertex,
